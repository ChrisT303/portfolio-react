  ...
  return (
    <div className="w-full h-screen  bg-eyes  bg-cover bg-center">
      <div className="max-w-[1000px] mx-auto px-12 flex flex-col justify-center  h-full">
        <p className="text-white custom-outline text-2xl font-bold "> Hello! My name is </p>
        ...
        <p className="ttext-white custom-outline font-bold py-4 text-xl sm:text-2xl max-w-[700px] text-opacity-80">
